...
summary: Web UI を通じて利用できるBlueXP classification機能は、REST API を通じても利用できます。 
---
= BlueXP分類API
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Web UI を通じて利用できるBlueXP classification機能は、REST API を通じても利用できます。
...
API リファレンスにアクセスするには、 BlueXP classificationインスタンスの IP アドレスが必要です。クラウド展開がある場合は、パブリック ID アドレスを使用します。例えば：
