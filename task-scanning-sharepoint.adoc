...
summary: Cloud Data Senseを使用して、SharePoint Onlineアカウントのファイルのスキャンを開始するには、いくつかの手順を実行します。 
---
...
[role="lead"]
Cloud Data Senseを使用して、SharePoint Onlineアカウントのファイルのスキャンを開始するには、いくつかの手順を実行します。
...
インターネットにアクセスできないサイトにData Senseがインストールされている場合は、Cloud Manager Connectorも同じサイトにインストールし、インターネットにアクセスできないようにする必要があります。 https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html["詳細はこちら。"^]。
